using CleanTemplate.Domain.SampleAggregate.Events;
using ErrorOr;
using SharedKernel.Domain.Core;
using static CleanTemplate.Domain.SampleAggregate.Sample;

namespace CleanTemplate.Domain.SampleAggregate;
